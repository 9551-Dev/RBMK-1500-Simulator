...
public class PCS extends Component {
    ...
    public PCS() {
        ...
        pcsFilterPressureHeader = new SimplePressureHeader(new Connectable[] { regenerator1, regenerator2,
                demineralizedWaterTank, feedwaterMixer1, feedwaterMixer2 }, 0.5);
        pcsFilterPressureHeader.isolationValveArray.get(0).setPosition(1.0f);
        pcsFilterPressureHeader.isolationValveArray.get(1).setPosition(1.0f); // open header valves for both regenerator
                                                                              // return circuits
        pcsCooler1 = new WaterWaterHeatExchanger(41.0f, 55.5, 65, pcsFilterPressureHeader, atmosphere); // drain2 is
                                                                                                        // atmo because
                                                                                                        // intermediate
                                                                                                        // loop is not
                                                                                                        // implemented
